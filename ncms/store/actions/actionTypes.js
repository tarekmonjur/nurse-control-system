...
export const GET_D_P_N_C = 'GET_DAILY_PATIENT_NURSE_CALL';
export const GET_D_P_N_C_RESULT = 'GET_DAILY_PATIENT_NURSE_CALL_RESULT';
export const GET_M_P_N_C = 'GET_MONTHLY_PATIENT_NURSE_CALL';
export const GET_M_P_N_C_RESULT = 'GET_MONTHLY_PATIENT_NURSE_CALL_RESULT';
